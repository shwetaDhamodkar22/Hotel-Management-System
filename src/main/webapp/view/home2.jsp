        ...
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
              <a class="dropdown-item" href="/homelogin">Booking</a>
              <a class="dropdown-item" href="/homelogin">Dinning</a>
              <div class="dropdown-divider"></div>
              
            </div>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="/homelogin">Contact us</a>
          </li>
          <li class="nav-item dropdown"></li>
        </ul>
        <a href="/sign" class="btn btn-primary btn-lg" role="button" aria-disabled="true">Register</a>
      </div>
    </nav>
    <h1 class="ml1">
